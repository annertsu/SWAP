...
<meta name="description" content="Facilitating you with your plant-based diet journey">
    ...
    <div id="noMeat" class="magic">
        ...
        <div class="allCards">
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">"DAK"GALBI</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">BOLOGNESE</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">GYOZA DUMPLINGS</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">GAPAO RICE</h2>
            </div> <!--recipeCard-->
            </a>
    ...
    <div id="noFish" class="magic">
        ...
        <div class="allCards">
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">"FISH" AND CHIPS</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">"TUNA" SASHIMI</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">"CALAMARI" RINGS</h2>
            </div> <!--recipeCard-->
            </a>
    ...
    <div id="noEggDairy" class="magic">
        ...
        <div class="allCards">
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">ARANCINI</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">FRUIT TART</h2>
            </div> <!--recipeCard-->
            </a>
            ...
            <div class="recipeCard">
                ...
                <h2 class="center black dishName">ORANGE CAKE</h2>
            </div> <!--recipeCard-->
            </a>
